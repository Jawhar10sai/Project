...
class AllAges35ramsExport implements FromCollection,WithStrictNullComparison,ShouldAutoSize,WithColumnWidths,WithStyles /*,WithCustomStartCell*/,WithHeadings
{
    use Exportable;
...
/*
    ...
    */
    ...
    {
        $list_info=Statistic::select('commercial','client','secteur','age_reel','age_avec_3_5ramassage')->where('nom_utilisateur',Auth::user()->name)->orderBy('age_avec_3_5ramassage', 'DESC')->get();
        return $list_info;
    }
}
