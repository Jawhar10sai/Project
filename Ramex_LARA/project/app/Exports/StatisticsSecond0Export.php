...
class StatisticsSecond0Export implements FromCollection,ShouldAutoSize,WithColumnWidths,WithStyles,WithHeadings,WithCustomStartCell,WithStrictNullComparison,WithCharts,WithColumnFormatting
{
    use Exportable;
       ...
       ///////
        ...
        return [
            ...
            'B2' => ['font' => ['size' => 16,'name'=>'Book Antiqua'],'alignment' => ['horizontal' => \PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER]],
             ...
             'A4:A'.$counter => ['font' => ['bold' => true,'size' => 10,'name'=>'Book Antiqua'],'alignment' => ['horizontal' => \PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER]],
    ...
    public function charts()
    {
        ...
        //Mettre les valeurs de la colonne b sous forme pourcentage
    ...
    */
    ...
    {
        $list_info=Statistics0ram::select('age','nbr_clients','pourcentage')->where('nom_utilisateur',Auth::user()->name)->orderBy('age', 'ASC')->get();
        return $list_info;
    }
}
