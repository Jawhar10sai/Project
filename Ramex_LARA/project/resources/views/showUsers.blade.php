...
<!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!--my table begin-->
                <button type="submit" class="btn btn-primary"  href="#" data-toggle="modal" data-target="#addUser"><i class="fas fa-plus" style="margin-right:5px"></i>Nouveau utilisateur</button>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="form-group">
                                 <input id="modpassword" type="password" class="form-control form-control-user @error('password') is-invalid @enderror"
                                  name="modpassword" placeholder="New Password" autocomplete="Nouveau mot de passe">
