    ...
    $(document).ready(function() {
        $.get("{{ route('AllStatistics1') }}", function(data, response){
                ...
                for (var i = 0; i < data.length; i++) {
                        ...
                        var line='<tr class="'+data[i].id+'"><td style="display:none;">'+data[i].id+'</td><td>'+data[i].commercial+'</td><td>'+data[i].client+'</td><td>'+data[i].age_reel+'</td><td>'+data[i].age_avec_0ramassage+'</td><td>'+data[i].age_avec_3_5ramassage+'</td><tr/>';
