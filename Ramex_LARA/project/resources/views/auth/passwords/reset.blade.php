...
<body class="bg-gradient-primary" style="background-image:url(' {{asset('customAuth/images/lavoieexp.jpg')}} ') ">
    ...
    <div class="container" style="margin-top:100px;">
        <div class="row justify-content-center" >
            <div class="col-md-8" >
                <div class="card" style="background-color:rgba(220, 220, 220, 0.3);color:white"">
                    <div class="card-header" style="background-color:rgb(231, 76, 48);color:white">{{ __('Réinitialiser le mot de passe') }}</div>
