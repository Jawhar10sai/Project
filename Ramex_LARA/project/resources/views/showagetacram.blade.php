                ...
                <div class="row justify-content-center">
                    <div class="col-11 col-sm-9 col-md-7 
                        ...
                        <div class="px-0 pt-4 pb-0 mt-3 mb-3">
                            <div id="form">
                                <ul id="progressbar" style="margin-left:35px">
                                    ...
                                    <li id="step2" ><strong>Etape 2</strong></li>
                               ...
                               <!--     <li id="step4" class="fn"><strong>Etape 4</strong></li>  -->
                                ...
                                <fieldset>
                                    <h2>Importer la feuille de ramassage</h2>
                                </fieldset>
                       ...
                       <!--         <fieldset>
                                ...
                                <form action="{{route('importExcel4')}}" method="post" enctype="multipart/form-data">
                                    @csrf

                                    <!--<div class="form-group">
                                        <label for="nbr_sec">Veuillez entrer le nombre des secteurs :</label>
                                        <input type="number" name="nbr_sec" min="1" class="form-control" id="nbr_sec" required>
                                    </div> -->

                                    <input type="file" name="file" accept=".xls, .xlsx">
                                    <button id="loadmodal" type="submit" class="btn btn-success">Valider</button>
                                    </form>
                            </div><!--end div id=form-->
                        </div>
                    </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">                
                    <!--<img src="{{ asset('customAuth/images/onlinegiftools.gif') }}" alt="" style="margin-right: 150%">-->
                    <img src="{{ asset('customAuth/images/load.gif') }}" alt="" style="margin-left: 33%"> 
    </div>
  </div>
  <!--load modal end-->
...
<!--select count clients with somme=3*5-->
<script>
    $(document).ready(function() {
...
<!--Afficher le modal myModal pour load event-->
<script>
    $(document).ready(function(){
