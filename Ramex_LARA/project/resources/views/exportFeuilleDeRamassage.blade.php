...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('homeresprdv')}}">
   ...
   <span style="font-size:15px">L'ge des clients avec </span>   
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a id="zero_ram_modal" class="collapse-item" href="{{route('zeroramview')}}">Zéro ramassage</a> 
 ...
 <li class="nav-item " >
    <a class="nav-link"  href="{{route('showRespRDVCommands')}}">
       ...
       <span style="font-size:14px">Liste des commandes</span>
    </a>
...
<!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                            ...
                            <div id="form">
                               ...
                               <!--     <li id="step4" class="fn"><strong>Etape 4</strong></li>  -->
                                ...
                                <form action="" method="" enctype="multipart/form-data">
                                    @csrf
                                    <button type="button" id="gen_fram_btn" class="btn btn-success" style="visibility:visible">Générer la feuille de ramassage</button>
                                    <a id="export_fram" href="{{route('exportFram')}}" class="btn btn-success" style="visibility:hidden" >Exporter la feuille de ramassage</a>
                                    </form>
           ...
           <div class="row justify-content-between">
                 <div class="col-md-2">
                   <a href="{{route('exportExcel0ram')}}" class="btn btn-success" style="margin-bottom:5px"><img src="{{asset('customAuth/images/excel.ico')}}" alt="" style="width:35px;height:35px">Exporter</a>
                </div>
            
                <div class="ml-auto mr-3" >
                   <a href="#" class="btn btn-danger" id="delete_table_btn" ><i class="fa fa-trash" aria-hidden="true" style="margin-right:5px" ></i>Vider la table</a>
                </div>
          </div>
...
<!--end of my table-->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     ...
     aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content" style="background-color:#ff0f0f;border-radius:20px;color:white;height:267px"> 
             ...
             <form id="deleteFormID">
              ...
              <div class="row">
                 ...
                 <div class="col-md-8" style="padding-top:50px;padding-left:50px"><center><h3>Voulez vous vraiment supprimer le contenu de cette table ?</h3></center></div>
             </div>
...
<script>
    $(document).ready(function() {
        $.get("{{ route('AllStatistics') }}", function(data, response){
                
                for (var i = 0; i < data.length; i++) {
                   
                        var line='<tr class="'+data[i].id+'"><td style="display:none;">'+data[i].id+'</td><td>'+data[i].commercial+'</td><td>'+data[i].client+'</td><td>'+data[i].age_reel+'</td><td>'+data[i].age_avec_0ramassage+'</td><tr/>';
...
<script>
    $(document).ready(function(){
        $("#gen_fram_btn").click(function(){
            $.ajax({
                type:"get",
                url:"{{route('generateFram')}}",
                success:function(data,response){
                $("#gen_fram_btn").css("visibility","hidden");
                 $("#export_fram").css("visibility","visible");
