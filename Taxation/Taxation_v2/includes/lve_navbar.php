...
require_once "gestion/control_utilisateur.php";
  $classhide = ($client_lve->CLIENT_TYP == "TR")? "d-none" : "";
?>
              ...
              <ul class="navbar-nav mr-auto">
                <li class="nav-item <?=$consultation;?>">
                 ...
                 <li class="nav-item <?=$messess;?>">
                  <a class="nav-link <?=$classhide;?>" href="Mes_sessions" style="font-size:18px;"><i class="fa fa-user" aria-hidden="true"></i> Mes sessions</a>
                </li>
                <?php endif; ?>
