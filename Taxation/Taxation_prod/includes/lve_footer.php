  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-4 col-xs-12">
        <div class="row h5">
          <p class="col-2">Capital</p>
          <p class="col-6">23.077.000,00 Dhs</p>
        </div>
        <div class="row h5">
          <p class="col-2">RC</p>
          <p class="col-6">95457</p>
        </div>
        <div class="row h5">
          <p class="col-2">IF</p>
          <p class="col-6">01601949</p>
        </div>
        <div class="row h5">
          <p class="col-2">Patente</p>
          <p class="col-6">37951124</p>
        </div>
        <div class="row h5">
          <p class="col-2">CNSS</p>
          <p class="col-6">2640961</p>
        </div>
        <div class="row h5">
          <p class="col-2">ICE</p>
          <p class="col-6">001526339000073</p>
        </div>
      </div>
      <div class="col-md-4 col-xs-12">
        <div class="row">
