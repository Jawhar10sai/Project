 <?php
  ...
  if ($client_lve->CLIENT_TYP == "TR" || $client_lve->CLIENT_TYP == "TRL")
 ...
 <!--###################################################################################-->
 <div class="container-fluid lve-content" style="margin-top:80px;">
   <div class="row">
     <div class="col-12">
       <div class="card">
           ...
           <form id="consult-form" action="" method="post" autocomplete="off">
             <div class="form-row">
               <div class="form-group col-md-4">
                 ...
                 <input type="text" class="form-control" name="num" value="<?= (isset($_POST['num'])) ? $_POST['num'] : ''; ?>">
               </div>
               <div class="form-group col-md-4">
                 <label for="">De:</label>
                 <input type="date" class="form-control" name="dat" value="<?= (isset($_POST['dat'])) ? $_POST['dat'] : ''; ?>">
               </div>
               <div class="form-group col-md-4">
                 <label for="">À:</label>
                 <input type="date" class="form-control" name="datt" value="<?= (isset($_POST['datt'])) ? $_POST['datt'] : ''; ?>">
               </div>
             </div>
             <div class="form-row">
               <div class="form-group col-md-4">
                 <label for="">Ville :</label>
                 <input type="text" class="form-control" name="vil" id="villerech" value="<?= (isset($_POST['vil'])) ? $_POST['vil'] : ''; ?>">
               </div>
               <div class="form-group col-md-4">
                 <label for="">Client Code/Nom:</label>
                 <input type="text" class="form-control" name="cod" value="<?= (isset($_POST['cod'])) ? $_POST['cod'] : ''; ?>">
               </div>
               <div class="form-group col-md-4">
                 <label for="">Numéro de BL :</label>
                 <input type="text" class="form-control" name="bl" value="<?= (isset($_POST['bl'])) ? $_POST['bl'] : ''; ?>">
               </div>
             </div>
