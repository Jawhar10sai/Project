...
$('#declaration-form-ajout').on('submit',function(event){
  ...
  $.ajax({
    ...
    success:function(res){
      ...
      $('#btn-envois').html('<i class="fas fa-save"></i>Confirmer la déclaration');
    }
  });
});
...
$('.info-perso').on('submit',function(event){
  ...
  $.ajax({
    ...
    success:function(res){
      ...
      $('#modif-infos').html('<i class="fas fa-save"></i> Enregistrer les changements');
    }
  });
});
  ...
  $.ajax({
    ...
    success:function(res){
      if (res =="modifie") {
        ...
        $('#mod-pass').html('<i class="fas fa-save"></i> Changer le mot de passe');
      }else {
        Swal.fire({
        icon: 'error',
        title: res
