...
<body>
  <div class="container-fluid lve-content" style="background-color:white;">
    <div class="row">
      <div class="col-12">
        <form class="panier-form" autocomplete="off" action="" method="post">
          <table class="table table-striped table-bordered table-responsive col-12">
            ...
            <?php if (!empty($client_lve->MesDeclarationsARamassees())) {
              foreach ($client_lve->MesDeclarationsARamassees() as $declarations) {
            ...
            if (count($client_lve->MesDeclarationsARamassees()) == 0) {
              ?>
              <tr>
