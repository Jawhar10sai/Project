...
<form name="codeform" action="http://www.lavoieexpress.com/phpmailer/mail.php" method="post">
  ...
  <input type="hidden" name="AddAddress" id="cdAddAddress" value="y.takourt@lavoieexpress.ma">
  <input type="hidden" name="addCC" id="cdAddcc" value="j.hassou@lavoieexpress.ma">
