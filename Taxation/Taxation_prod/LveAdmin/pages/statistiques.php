<?php $clientsnombres = Connection::getConnection()->query("SELECT * FROM `clientsnombres` ORDER BY `total_sous_clients` DESC");  ?>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="card stat-card">
            ...
            <h1 class="text-center" style="margin-top:2rem;"><?= count(ClientLve::ListeClients()); ?></h1>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="card stat-card">
            <h4>Nombre des sous-clients</h4>
            <h1 class="text-center" style="margin-top:2rem;"><?= count(SousClient::ListeClients()); ?></h1>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="card stat-card">
            <h4>Nombre des déclarations</h4>
            <h1 class="text-center" style="margin-top:2rem;"><?= count(Declarations::ListeDeclarations()); ?></h1>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="card stat-card">
            <h4>Nombre des sous-sessions</h4>
            <h1 class="text-center" style="margin-top:2rem;"><?= count(ClientSession::ListeSessions()); ?></h1>
          </div>
        </div>
      </div>
      <!-- *********************************** Graphs row**************************************** -->
            ...
            <div class="card-body">
              <table class="table table-striped">
                <tbody>
                  ...
                  foreach (ClientLve::TopClients(5) as $clint) : ?>
                    <tr>
                      <td><?= $clint->NOM; ?></td>
