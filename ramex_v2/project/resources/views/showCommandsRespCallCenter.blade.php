...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('homerespcallcenter')}}">
  ...
  <li class="nav-item " style="margin-top:70px">
    <a class="nav-link" href="{{route('homerespcallcenter')}}">
 ...
 <li class="nav-item " >
    <a class="nav-link" href="{{route('showClientsRespCallCenter')}}">
 ...
 <li class="nav-item active" >
    <a class="nav-link"  href="{{route('showCommandsRespCallCenter')}}">
...
<div class="container">
          ...
          <div class=" col-md-6 ">
              ...
              <a class="filtrer-par" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"><i id="down-icon" class="fas fa-angle-down fa-2x" style="display:none; float:right"></i><i id="up-icon" class="fas fa-angle-up fa-2x" style="float:right"></i></h5></a>
                </div> 
         ...
         <div class="form-content-add-form">
             <div class="row">
                <div class="col-md-12">
                    ...
                    <center>
                    <button type="button" id="save" class="btn btn-primary btn-lg ">Enregistrer</button>
      ...
      <div class="modal-body">
        ...
        <div class="col-lg-12">
          ...
          <!--
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <input id="num_tel_client_ajout" type="tel"  pattern="[0-9]"  maxlength="14" class="form-control form-control-user @error('num_tel_client') is-invalid @enderror"
                      ...
                      <center>  
                        <button type="button" id="save2" class="btn btn-primary">Enregistrer </button>
        ...
        <div class="modal fade" id="affecter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            ...
            <center> <button type="button" id="affecter-btn" class="btn btn-primary">Affecter</button>
                ...
                {{-- <button type="button" id="afficher-btn" class="btn btn-success">Afficher</button> --}}
...
<div class="modal fade " id="affecte-ramasseur" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl"  style="width:1200px;" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#4e73df;color:white">
        <h5 class="modal-title" id="exampleModalLabel">Affectation du Ramassage N&deg; <span id="num_ramasse_af"></span> </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true" style="color:white">&times;</span>
        </button>
      </div>
...
<script>
    ...
    <!--Search bar-->
     ...
     <script>
        ...
        <!--display the appropriate Modal after click on events class-->
          <script>
          $(document).ready(function(){
          ...
          $("#affecter-btn").click(function(){
              ...
              var url_="{{route('SelectedCommandById')}}";
                $.get( url_ , data , function(data, response){
                 ...
                 $("#num_ramasse_af").text(data[0].num_ramasse);
...
<script>
  $(document).ready( function(){
      ...
      //select sectors
     // $('#agence_client_ajout').change( function(){
