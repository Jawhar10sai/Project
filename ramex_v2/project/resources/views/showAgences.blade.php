...
<!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!--my table begin-->
                <button type="submit" class="btn btn-primary"  href="#" data-toggle="modal" data-target="#addAgence"><i class="fas fa-plus" style="margin-right:5px"></i>Nouvelle agence</button>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     ...
     <!--success modal begin-->
      ...
      <!--susccess modal end-->
       ...
       <!--delete motif modal-->
    <div class="modal fade" id="deleteAgence" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="background-color:#ff0f0f;border-radius:20px;color:white;height:250px"> 
            ...
            <form id="deleteFormID">
             ...
             {{csrf_field()}}
             {{method_field('delete')}}
             <input type="hidden" name="iddelagence" id="iddelagence" value="">
             <div class="row">
                <div class="col-md-4"> <img src="{{ asset('customAuth/images/warning.gif') }}" alt="" style="width:150px;height:150px"></div>
                <div class="col-md-8" style="padding-top:50px;padding-left:50px"><center><h3>Voulez vous vraiment supprimer cette agence?</h3></center></div>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#4e73df;color:white">
        <h5 class="modal-title" id="exampleModalLabel">Ajouter une nouvelle agence</h5>
      ...
      <div class="modal-body">
        ...
        <div class="col-lg-12">
                    ...
                    <form id="addform" class="agence" enctype="multipart/form-data">
                     @csrf


                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <input id="agence" type="text" class="form-control"
                                 name="agence" value="{{ old('agence') }}" placeholder="Veuillez entrer une agence" autocomplete="off">
...
$(document).ready(function(){
    $.get("{{ route('AllAgences') }}", function(data, response){
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    var line='<tr class="'+data[i].id+'"><td>'+data[i].id+'</td><td>'+data[i].nom_agence+'</td><td>'+data[i].adresse_agence+'</td><td>'+data[i].telephone_agence+'</td><td> <a class="btn btn-primary editbtn" href="#" style="margin-right:3px"><i class="fas fa-pen"></i>Modifier</a></button><a class="btn btn-danger delbtn" href="#"  ><i class="fas fa-trash"></i>Supprimer</a></td><tr/>';
                    $('#tabagences').append(line);
                }
    ...
    <!--Search bar-->
     ...
     <script>
           $(document).ready(function(){
            ...
            $('#id').val(data[0]);
            $('#modagence').val(data[1]);
            $('#modadresse').val(data[2]);
            $('#modnum_tel').val(data[3]);
              ...
              $('#editform').on('submit',function(e){
                  ...
                  var mydata={
                      id:$('#id').val(),
                      agence: $('#modagence').val().toUpperCase(),
                      adresse:$('#modadresse').val().toUpperCase(),
                      num_tel:$('#modnum_tel').val()
                  }
                  //alert(mydata.num_tel);
                 $.ajax({
                     type:"PUT",
                     url:"{{route('updateagence')}}",
                     data:mydata,
                     headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                    // data:$(this).serialize(),
                     success:function(data,response){
     ...
     <script>
        ...
        /*    $(document).on("click","#delete",function(e){
              ...
              $('#deleteFormID').on('submit',function(e){
               e.preventDefault();
               var id=$('#iddelagence').val();

               $.ajax({
                     type:"delete",
                     url:"{{route('deleteAgence')}}",
                     data:$(this).serialize(),
                     success:function(data,response){
