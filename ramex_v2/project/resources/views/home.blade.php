...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <i class="fas fa-fw fa-cog"></i> Gestion des utilisateurs
            </div>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span>Utilisateurs RAMEX</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">utilisateurs:</h6>
                        <a class="collapse-item" href="{{route('showUsers')}}"><i class="fas fa-eye" style="margin-right:5px"></i>Liste des utilisateurs</a>
                        <a class="collapse-item" href="{{route('showMotifs')}}"><i class="fas fa-eye" style="margin-right:5px"></i>Liste des motifs</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <span>Commandes et clients</span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                     <!--   <h6 class="collapse-header">Commandes:</h6> -->
                        <a class="collapse-item" href="{{route('showClients')}}"><i class="fas fa-eye" style="margin-right:5px"></i>Liste des clients</a>
                        <a class="collapse-item" href="{{route('showCommands')}}"><i class="fas fa-eye" style="margin-right:5px"></i>Liste des commandes</a>
                        </div>
                </div>
            </li>  
