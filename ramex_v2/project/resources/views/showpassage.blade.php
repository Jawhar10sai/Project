                ...
                <div class="row justify-content-center">
                    <div class="col-11 col-sm-9 col-md-7 
                       ...
                       <!--         <fieldset>
                                ...
                                <form action="{{route('importExcel7')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                 ...
                 <!--my table begin-->
                    ...
                    <div class="row">
                       ...
                       <div class="row justify-content-between">
                        ...
                        <div class="col-md-6">
                            <center> <h3><b><span id="fram_clients"></span></b> clients trouvés</h3></center>
                             </div>
...
<script>
    $(document).ready(function() {
        $.get("{{ route('AllStatistics3') }}", function(data, response){
                
                for (var i = 0; i < data.length; i++) {
                   
                        var line='<tr class="'+data[i].id+'"><td style="display:none;">'+data[i].id+'</td><td>'+data[i].client+'</td><tr/>';
