                        ...
                        <div class="px-0 pt-4 pb-0 mt-3 mb-3">
                            ...
                            <!--    <fieldset>
                                ...
                                <form action="{{route('importFram')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <fieldset>
                                        <h2>Importer les fichiers de l'age des clients avec 3*5 ramassages</h2>
                                    </fieldset>
                                   ...
                                   <!--<li class="list-group-item list-group-item-success">This is a success list group item</li>--> 
                                    ...
                                    <form action="{{route('importExcel6')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                 ...
                 <div class="col-md-3">
                    ...
                    <div class="btn-group dropup">
                        ...
                        <div class="dropdown-menu" style="font-size: 18px;background-color:#17a673">
                          <a id="exportfile" href="#" class="dropdown-item" style="color:white"><i class="fas fa-download"></i> Clients avec Age 3*5 (Spécial pour le commercial)</a>
                          <a id="exportfileagereel" href="#" class="dropdown-item" style="color:white"><i class="fas fa-download"></i> Clients avec Age réel</a>
                          <a id="exportage35all" href="#" class="dropdown-item" style="color:white"><i class="fas fa-download"></i>Tous les Clients avec Age 3*5</a>
                        </div>
                      </div>
                    {{-- <a id="exportfile" href="#" class="btn btn-success" style="margin-bottom:5px"><img src="{{asset('customAuth/images/excel.ico')}}" alt="" style="width:35px;height:35px">Exporter Age 3*5</a> --}}
                  {{-- <a id="exportfileagereel" href="#" class="btn btn-success" style="margin-bottom:5px"><img src="{{asset('customAuth/images/excel.ico')}}" alt="" style="width:35px;height:35px">Exporter Age reel</a> --}}
                    <!--   <a href="{{route('exportSecondExcel35ram')}}" class="btn btn-success" style="margin-bottom:5px"><img src="{{asset('customAuth/images/excel.ico')}}" alt="" style="width:35px;height:35px">test</a> -->
                </div>

                <div class="col-md-6">
                    <center> <h3><b><span id="age_35ram_null"></span></b> clients avec age 3*5 ramassages = null</h3></center>
                </div>
...
<!--end of my table-->
 ...
 <!-- nombre des clients modal-->
 <div class="modal fade" id="NbrClientsModal" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        
        <div class="modal-body">
          <center> <h5><b><span id="age_35ram_null"></span></b> clients avec age 3*5 ramassages = null</h5></center> 
        </div>
     
        <center><button type="button" class="btn btn-danger" data-dismiss="modal" style="margin-bottom: 10px"><i class="fas fa-close"></i> Fermer</button></center>  
 ...
 <div class="modal fade" id="exportexcelfile_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('exportExcel35ram')}}" method="get" enctype="multipart/form-data">
                @csrf
                <input type="text" class="form-control form-control-lg" name="nom_fichier_excel" value="Clients avec 3*5 ramassages S" placeholder="Exemple: Clients avec 3*5 ramassages S15">
  ...
  <!--end 3*5 export excel file Modal -->
...
<div class="modal fade" id="exportagereelexcelfile_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <!--end export excel age reel file Modal -->
        ...
        <!--export excel all clients with age 3*5 rams file Modal -->
<div class="modal fade" id="exportage35ramsexcelfile_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('exportExcel35ram2')}}" method="get" enctype="multipart/form-data">
                @csrf
                <input type="text" class="form-control form-control-lg" name="nom_fichier_excel" value="AGE 3*5 RAMASSES SEMAINE " placeholder="Exemple: AGE 3*5 RAMASSES SEMAINE 20">
                <div style="margin-top:10px">
                    <center>
  ...
  <!--end export excel all clients with age 3*5 rams file Modal -->
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg  modal-lg-stat" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color:rgb(2, 117, 216);color:white">
          <h3 ><i class="far fa-chart-bar"></i> Diagramme clients avec 3*5 ramassages</h3>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="" method="get" enctype="multipart/form-data">
                @csrf
               <h6>Veuillez entrer l'age avec 3*5 ramassages du client par semaine :</h6>
               <input type="text" id="id_client" hidden>
                <input type="number" id="age_3_5ram_client" class="form-control form-control-lg" name="age_3_5ram_client" placeholder="Exemple: 9">
                <div style="margin-top:10px">
                    <center>
...
<script>
    $(document).ready(function() {
        $.get("{{ route('AllStatistics2') }}", function(data, response){
                
                for (var i = 0; i < data.length; i++) {
                   
                    
                        var line='';
                        if(data[i].age_avec_3_5ramassage == null){
                            line='<tr class="'+data[i].id+' clickabletr" style="background-color:rgb(231, 161, 176)"><td style="display:none;">'+data[i].id+'</td><td>'+data[i].commercial+'</td><td>'+data[i].client+'</td><td>'+data[i].age_reel+'</td><td>'+data[i].age_avec_3_5ramassage+'</td><td>'+data[i].nom_fichier_age_3_5ram+'</td><tr/>';
                        }else{
                            line='<tr class="'+data[i].id+'"><td style="display:none;">'+data[i].id+'</td><td>'+data[i].commercial+'</td><td>'+data[i].client+'</td><td>'+data[i].age_reel+'</td><td>'+data[i].age_avec_3_5ramassage+'</td><td>'+data[i].nom_fichier_age_3_5ram+'</td><tr/>';
                        }
                       
                        $('#tabstatistics').append(line);
                     
                       // var line='<tr class="'+data[i].id+'"><td style="display:none;">'+data[i].id+'</td><td>'+data[i].commercial+'</td><td>'+data[i].client+'</td><td>'+data[i].age_reel+'</td><td>'+data[i].age_avec_3_5ramassage+'</td><td>'+data[i].nom_fichier_age_3_5ram+'</td><tr/>';
...
<!--select count age_3*5ram_null-->
<script>
    $(document).ready(function() {
        $.get("{{ route('AllNullAge35ram') }}", function(data, response){
                
                    $("#age_35ram_null").text(data);
                //    $("#NbrClientsModal").modal('show');
...
/*        
    if ($('#filenames li').length != 0){
        ...
        $.get("{{ route('importedfiles') }}", function(data, response){
                    ...
                    for (var i = 0; i < data.length; i++) {
                        if(data[i].type_fichier == "age_tac_ram"){
...
<!--Exporter le fichier de l'age 3*5 de tous les clients de la feuille de ramasse-->
<script>
    $(document).ready(function(){
      $("#exportage35all").click(function(){
        $(".modal").modal("hide");
                ...
                // alert(age);
                 ...
                 $.ajax({
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                     ...
                     window.location = "{{route('tacram3view')}}";

                         $('#id_client').val("")
                         $('#age_3_5ram_client').val("");
