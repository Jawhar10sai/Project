        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="min-height:79%">
                    ...
                    <div class="btn-group">
                        <button type="button" style="margin-bottom:5px" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-chart-bar"></i> Afficher les diagrammes à barres</button>
                        <div class="dropdown-menu" style="font-size: 18px;background-color:#0275d8">
                          <a id="show_chart" href="#" class="dropdown-item dropdown-item2" style="color:white"><i class="fas fa-chart-bar"></i> Clients avec Age 0 ramassage</a>
                          <a id="show_sec_chart" href="#" class="dropdown-item dropdown-item2" style="color:white"><i class="fas fa-chart-bar"></i> Clients avec Age 3*5 ramassages</a>
                        </div>
                      </div>
               {{-- <button id="show_chart" class="btn btn-primary"><i class="fas fa-chart-bar"></i> Afficher le diagramme à barres</button>
               <button id="show_sec_chart" class="btn btn-primary"><i class="fas fa-chart-bar"></i> Afficher le diagramme à barres</button> --}}
                        ...
                        <div class="px-0 pt-4 pb-0 mt-3 mb-3">
                            ...
                            <!--    <fieldset>
                                ...
                                <form action="{{route('importFram')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <fieldset>
                                        <h2>Vos fichiers sont prêts pour le téléchargement</h2>
                                    </fieldset>
                 ...
                 <div class="col-md-3">
                    ...
                    <div class="btn-group dropup">
                        ...
                        <div class="dropdown-menu" style="font-size: 18px;background-color:#17a673">
                          ...
                          <a id="exportfile" href="#" class="dropdown-item" style="color:white"><i class="fas fa-download"></i> Clients avec Age 0 ramassage</a>
                          <a id="exportfile2" href="#" class="dropdown-item" style="color:white"><i class="fas fa-download"></i> Clients avec Age 3*5 ramassages</a>
                          <a id="exportglobalfile" href="#" class="dropdown-item" style="color:white"><i class="fas fa-download"></i>Fichier global</a>
                        </div>
                      </div>
           ...
           <thead class="thead thead-dark">
             ...
             <th>Âge avec 3*5 ramassages (En semaine)</th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('exportExcel0ram')}}" method="get" enctype="multipart/form-data">
                @csrf
                <input type="text" class="form-control form-control-lg" name="nom_fichier_excel" value="Clients avec 0 ramassage S" placeholder="Exemple: Clients avec 0 ramassage S15">
...
<div class="modal fade" id="exportage35ramsexcelfile_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color:rgb(75, 181, 67);color:white">
          <h3 ><i class="fa fa-file-excel-o"></i> Choisir un nom au fichier</h3>
        ...
        <div class="modal-body">
            <form action="{{route('exportExcel35ram')}}" method="get" enctype="multipart/form-data">
                @csrf
                <input type="text" class="form-control form-control-lg" name="nom_fichier_excel" value="Clients avec 3*5 ramassages S " placeholder="Exemple: Clients avec 3*5 ramassages S20">
                <div style="margin-top:10px">
                    <center>
...
<div class="modal fade" id="exportglobalfileexcelfile_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color:rgb(75, 181, 67);color:white">
          <h3 ><i class="fa fa-file-excel-o"></i> Choisir un nom au fichier</h3>
        ...
        <div class="modal-body">
            <form action="{{route('exportFglobal')}}" method="get" enctype="multipart/form-data">
                @csrf
                <input type="text" class="form-control form-control-lg" name="nom_fichier_excel" value="FICHIER GLOBAL S" placeholder="Exemple: FICHIER GLOBAL S20">
                <div style="margin-top:10px">
                    <center>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('exportAgereelFile')}}" method="get" enctype="multipart/form-data">
                        ...
                        <div style="margin-top:10px">
                            <center>
                                <button id="close_export_file_modalx" type="submit" class="btn btn-success" style="margin-right:3px"><i class="fas fa-download"></i> Exporter</a>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>  
                            </center>  
                        </div>  
                        </form>
 ...
 <div class="modal fade" id="export_chart_excelfile_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <!--end export excel file Modal -->
        ...
        <!--export sec_chart excel file Modal -->
 <div class="modal fade" id="export_sec_chart_excelfile_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color:rgb(75, 181, 67);color:white">
          <h3 ><i class="fa fa-file-excel-o"></i> Choisir un nom au fichier</h3>
        ...
        <div class="modal-body">
            <form action="{{route('exportSecondExcel35ram')}}" method="get" enctype="multipart/form-data">
                @csrf
                <input type="text" class="form-control form-control-lg" name="nom_fichier_excel" value="Diagramme Clients avec 3*5 ramassages S" placeholder="Exemple: Diagramme Clients avec 3*5 ramassages S15">
                <div style="margin-top:10px">
                    <center>
                        <button id="close_export_chart_modal2" type="submit" class="btn btn-success" style="margin-right:3px"><i class="fas fa-download"></i> Exporter</a>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>  
                    </center>  
                </div>  
                </form>
  ...
  <!--end export sec_chart excel file Modal -->
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg modal-lg-stat" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color:rgb(2, 117, 216);color:white">
          <h3 ><i class="far fa-chart-bar"></i> Diagramme clients avec 0 ramassage (<span id="nbr_clients_zeroram"></span> Clients)</h3>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<!--chart body end-->
  ...
  <!--end Chart-bar Modal -->
       ...
       <!--sec chart-bar Modal -->
<div class="modal fade bd-example-modal-lg" id="sec_chartbar_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg  modal-lg-stat" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color:rgb(2, 117, 216);color:white">
          <h3 ><i class="far fa-chart-bar"></i> Diagramme clients avec 3*5 ramassages (<span id="nbr_clients_tacram"></span> Clients)</h3>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="color:white">&times;</span>
          </button>
        </div>
        ...
        <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <!--my chart-->             
                    <div id="sec_chart" class="chart-area">
    ...
    <div class="row">
        ...
        <div class="card shadow mb-4">
           ...
           <div class="card-body">
               ...
               <!--my chart-->             
               <div id="sec_chart_percent" class="chart-area">
...
<!--chart body end-->
            <div style="margin-top:10px">
                    <center>
                     <!--   <button id="download_as_pdf" type="submit" class="btn btn-success" style="margin-right:3px"><i class="fas fa-download"></i> Exporter</a>-->
                      <a id="download_sec_chart" href="#" class="btn btn-success btn-lg"  style="height: 50px"><img src="{{asset('customAuth/images/excel.ico')}}" alt="" style="width:35px;height:35px">Exporter</a> 
                        <button type="button" class="btn btn-secondary btn-lg" data-dismiss="modal"  style="height: 50px">Fermer</button>  
                    </center>  
                </div>  
        </div>
...
<div class="modal fade" id="updatenullage_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <!--end export excel file Modal -->
<input id="age_test" type="hidden" value="2">
...
<script>
    $(document).ready(function() {
        $.get("{{ route('AllStatistics5') }}", function(data, response){
            ...
            el: '#sec_chart',
            url: "@chart('clients_avec35_ram_chart')",
            hooks: new ChartisanHooks()
            .beginAtZero()
            .responsive()
            .colors(),
            ...
            el: '#sec_chart_percent',
            url: "@chart('clients_avec35_ram_pourcentage_chart')",
            hooks: new ChartisanHooks()
            .beginAtZero()
            .responsive()
            .colors(),
             ...
             /* clients avec age 0 ram diagramme */
            $.get("{{ route('Allstatszeroram') }}", function(data, response){
             ...
             /* clients avec age 3*5 rams diagramme */  
             $.get("{{ route('Allstats35rams') }}", function(data, response){
...
<!--compter le nbr des clients avec 0ram et 3*5 rams -->
<script>
    $(document).ready(function() {
        $.get("{{ route('AllNullSomme') }}", function(data, response){ 
               $("#nbr_clients_zeroram").text(data); 
            });

            $.get("{{ route('All35Somme') }}", function(data, response){ 
               $("#nbr_clients_tacram").text(data);  
            });
...
<!--Afficher le modal du 2eme diagramme-->
<script>
    $(document).ready(function(){
      $("#show_sec_chart").click(function(){
        $("#sec_chartbar_modal").modal("show");
      })
      });
</script>
...
<script>
    $(document).ready(function(){
      ...
      $("#download_sec_chart").click(function(){
        $("#sec_chartbar_modal").modal("hide");
        $("#export_sec_chart_excelfile_modal").modal("show");
      })

      $("#close_export_chart_modal2").click(function(){
        $(".modal").modal("hide");
      })
...
<script>
    $(document).ready(function(){
      $("#exportfile2").click(function(){
        $(".modal").modal("hide");
        $("#exportage35ramsexcelfile_modal").modal("show");
...
<script>
    $(document).ready(function(){
      ...
      $("#close_export_file_modalx").click(function(){
        $(".modal").modal("hide");
      })
...
<script>
    $(document).ready(function(){
      $("#exportglobalfile").click(function(){
        $(".modal").modal("hide");
        $("#exportglobalfileexcelfile_modal").modal("show");
