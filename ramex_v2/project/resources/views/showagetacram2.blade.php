                        ...
                        <div class="px-0 pt-4 pb-0 mt-3 mb-3">
                            <div id="form">
                               ...
                               <!--     <li id="step4" class="fn"><strong>Etape 4</strong></li>  -->
                                ...
                                <fieldset>
                                    <h2>Importer l'age réel des clients </h2>
                                </fieldset>
                               ...
                               <!--<li class="list-group-item list-group-item-success">This is a success list group item</li>--> 
                                ...
                                <form action="{{route('importExcel5')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                          ...
                          <div style="margin-top:10px">
                            <a href="{{route('tacram3view')}}" class="btn btn-success">Passer à l'étape 3 >></a>
                        </div>  
                        </div>
                    </div>
                </div>
              ...
              <!--multi step progress bar end-->
                 ...
                 <div class="row">
                   ...
                   <div class="row justify-content-between">
                      ...
                      <div class="col-md-6">
                        <center> <h3><b><span id="somme_35"></span></b> clients trouvés</h3></center>
                         </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('exportExcel35ram')}}" method="get" enctype="multipart/form-data">
                @csrf
                <input type="text" class="form-control form-control-lg" name="nom_fichier_excel" value="Client avec 3*5 ramassages S" placeholder="Exemple: Client avec 3*5 ramassages S15">
                <div style="margin-top:10px">
                    <center>
...
<script>
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if(data[i].age_reel == null){
                            line='<tr class="'+data[i].id+' clickabletr" style="background-color:rgb(231, 161, 176)"><td style="display:none;">'+data[i].id+'</td><td>'+data[i].commercial+'</td><td>'+data[i].client+'</td><td>'+data[i].age_reel+'</td><td>'+data[i].age_avec_3_5ramassage+'</td><tr/>';
                        }else{
                            line='<tr class="'+data[i].id+'"><td style="display:none;">'+data[i].id+'</td><td>'+data[i].commercial+'</td><td>'+data[i].client+'</td><td>'+data[i].age_reel+'</td><td>'+data[i].age_avec_3_5ramassage+'</td><tr/>';
                        }
                       ...
                       // var line='<tr class="'+data[i].id+'"><td style="display:none;">'+data[i].id+'</td><td>'+data[i].commercial+'</td><td>'+data[i].client+'</td><td>'+data[i].age_reel+'</td><td>'+data[i].age_avec_3_5ramassage+'</td><tr/>';
    ...
    <!--select count clients with somme=0-->
<script>
    $(document).ready(function() {
