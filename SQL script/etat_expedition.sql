...
/****** Object:  StoredProcedure [dbo].[ps_mise_a_jours_etat_expedition]    Script Date: 16/11/2020 10:27:03 ******/
SET ANSI_NULLS ON
GO
...
insert into #EventId
 ...
 begin
        ...
        SET @TSQL =@TSQL+'statut  ='''+isnull(@STATUS_LIV,'')+''' ,'
				SET @TSQL =@TSQL+'statut_suivis  ='''+isnull(@STATUS,'')+''' ,
