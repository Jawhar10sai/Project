...
class Pop {
	 ...
	 * 
	 * @param integer $num		: Num&eacute;ro du message
	 * @param integer $max_line	: Nombre maximal de ligne à renvoyer (par d&eacute;faut, tout le message)
	 * 
	 * @access public
	 * 
	 * @return boolean
	 ...
	 * Pop::parse_headers()
	 * 
	 * R&eacute;cup&egrave;re les entêtes de l'email sp&eacute;cifi&eacute; par $num et renvoi un tableau avec le 
	 ...
	 * 
	 * D&eacute;code l'entête donn&eacute; s'il est encod&eacute;
	 * 
	 * @param $str
	 * 
	 * @access private
	...
	{
		//
		// On v&eacute;rifie si l'entête est encod&eacute; en base64 ou en quoted-printable, et on 
	 ...
	 * ou false si aucun fichier joint n'est trouv&eacute; ou que l'email correspondant à $num n'existe pas.
	 * 
	 * [pas au point: beta]
	 * 
	 * @param integer $num 	: Num&eacute;ro de l'email à parser
	 * 
	 * @access public
	 * 
	 * @return mixed
