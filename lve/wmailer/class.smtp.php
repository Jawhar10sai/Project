 ...
 * d&eacute;taill&eacute;es dans la RFC 821.
 * 
 * Les commandes d'authentification au serveur sont d&eacute;taill&eacute;es dans la RFC 2554
 * 
...
class Smtp {
	...
	/*
     * Port d'acc&eacute;s (en g&eacute;n&eacute;ral, 25)
     *
     * @var	integer
	 * 
	 * @access public
	...
	/*
     * login pour la connexion (seulement si n&eacute;cessaire)
     *
     * @var	string
	 * 
	 * @access public
	...
	/*
     * password pour la connexion (seulement si n&eacute;cessaire)
     *
     * @var	string
	 * 
	 * @access public
	...
	/*
     * Code de la derni&egrave;re r&eacute;ponse
     *
     * @var	string
	 * 
	 * @access private
	 ...
	 * Si activ&eacute;, le dialogue avec le serveur s'affiche à l'&eacute;cran, une &eacute;ventuelle erreur stoppe le script
     *
     * @var	boolean
	 * 
	 * @access public
	 ...
	 * 
	 * @param boolean $auto_connect	: TRUE pour &eacute;tablir la connexion à l'instanciation de la classe
	 * 
	 * @return void
	 */
	 ...
	 * Smtp::connect()
	 * 
	 * Etablit la connexion au serveur SMTP et effectue l'identification
	 * 
	 * @param string  $smtp_server	: Nom ou IP du serveur
	 * @param integer $smtp_port	: Port d'acc&eacute;s au serveur SMTP
	 * @param string  $smtp_user	: login pour la connexion (seulement si n&eacute;cessaire)
	 * @param string  $smtp_pass	: password pour la connexion (seulement si n&eacute;cessaire)
	...
	function connect($smtp_server = '', $smtp_port = 25, $smtp_user = '', $smtp_pass = '', $server_from = '')
	{
		...
		//
		// Comme on est poli, on dit bonjour, et on s'authentifie le cas &eacute;ch&eacute;ant 
		// 
		// Code success	: 250
	 ...
	 * Smtp::authenticate()
	 * 
	 * Authentification aupr&egrave;s du serveur, s'il le supporte
	 * 
	 * @access public
	 * 
	 * @return boolean
	 ...
	 * 
	 * @param string $input	: Donn&eacute;es à envoyer
	 * 
	 * @access private
	 * 
	 * @return void
	 ...
	 * Smtp::get_reponse()
	 * 
	 * R&eacute;cup&egrave;re la r&eacute;ponse du serveur et la parse pour obtenir le code r&eacute;ponse
	 * 
	 * @access private
	 * 
	 * @return boolean
	 ...
	 * 
	 * Commande MAIL FROM
	 * Envoi l'adresse email de l'exp&eacute;diteur au serveur SMTP
	 * 
	...
	{
		//
		// On sp&eacute;cifie l'adresse de l'exp&eacute;diteur
		//
		// Code success	: 250
	...
	{
		//
		// On sp&eacute;cifie les destinatires au serveur smtp
		//
	...
	function send($headers, $message)
	{
		...
		// pour &eacute;viter que le serveur ne l'interpr&egrave;te comme la fin de l'envoi
		//
		$message = preg_replace("/\r\n\.\r\n/", "\r\n..\r\n", $message); 
		
		//
		// On indique au serveur que l'on va lui livrer les donn&eacute;es
		//
		// Code interm&eacute;diaire 	: 354
		//
		$this->put_data('DATA'); 
		...
		//
		// On indique la fin de l'envoi de donn&eacute;es au serveur
		//
		// Code success	: 250
	...
	{
		//
		// Comme on est poli, on dit aurevoir au serveur avec la commande ad&eacute;quat QUIT 
		//
		// Code success	: 221
        // Code failure	: 500
		//
