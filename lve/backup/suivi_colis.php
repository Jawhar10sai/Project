...
<tr>
  ...
  <table width="100%"><tr><td height="170" colspan="3" align="left" valign="top"><?php include('banniere2.html'); ?></td>
    </tr>
    
 
    <tr>
      <td width="25%" height="257" align="left" valign="top"><?php include('menu_gauche_cp.html');?></td>
      <td width="4%" align="left" valign="top"></td>
      <td width="70%" align="left" valign="top">
	  <b>Conseils & Pratiques > Suivi de Colis</b><br />
	  <br />
	  <span class="titre1">Suivi de colis </span>
        <p>&nbsp;</p></td>
    </tr>
  </table></td>
