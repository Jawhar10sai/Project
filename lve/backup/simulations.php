...
<tr  >
  ...
  <table width="100%"><tr><td height="168" colspan="3" align="left" valign="top"><?php include('banniere2.html'); ?></td>
    ...
    <tr>
      <td width="24%" height="257" align="left" valign="top"><?php include('menu_gauche_cp.html');?></td>
      <td width="4%" align="left" valign="top"></td>
      <td width="72%" align="left" valign="top">
	  <b>Conseils & Pratiques > Simulations</b><br /><br />
	  <span class="titre1">Simulations</span><br />
        <p><span class="titre2">Délais et tarifs</span></p>
		<p>

Recherchez les dates et heures de livraison et les disponibilités pour vos expéditions en consultant les délais et tarifs.<br /><br />
		</p></td>
    </tr>
  </table></td>
