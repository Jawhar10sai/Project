	...
	initialize: function(options) {
		...
		this.options = $H({
			...
			strings : { // allows for localization
				closeLink : 'Fermer',
				loadingMsg : 'loading',
				nextLink : 'suivant &raquo;',
				prevLink : '&laquo; pr&eacute;c&eacute;dant',
				startSlideshow : 'D&eacute;marrer animation',
				stopSlideshow : 'Arr&ecirc;ter animation',
				numDisplayPrefix : 'Image',
				numDisplaySeparator : 'sur'
			}
        }).merge(options);
