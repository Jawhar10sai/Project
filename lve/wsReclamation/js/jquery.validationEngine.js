...
$(document).ready(function() {
		...
		$("#situation_matrimoniale").change(function(){
				...
				if(valeur=="Célibataire"){
					$('div.show_celib').hide();
				$("#nombre_enfants").removeClass("validate[required]");
				$("#statut_conjoint").removeClass("validate[required]");
					
					
				}else if(valeur=="Marié(e)"){
				$("#situation_patrimoniale").addClass("validate[required]");
				}else{
					$('div.show_celib').show();
				$("#nombre_enfants").addClass("validate[required]");
				$("#statut_conjoint").addClass("validate[required]");
					}
			});
