 <div id="Espace_Securise">
   ...
   $page_Inscription = "SELECT c.id_page FROM pages p,contenu c where p.id_site = '".$idsite."' AND c.id_page = p.id AND c.type = 'Inscription' LIMIT 1";
	$req_page_Inscription  = mysql_query($page_Inscription ,$connect);
	$row_page_Inscription = mysql_fetch_assoc($req_page_Inscription);
	$num_page_Inscription = mysql_num_rows($req_page_Inscription);
	...
	$num_page_profil = mysql_num_rows($req_page_profil);
        ...
        <form method="post" action="" id="form_membre">
          ...
          <div class="login_block" style="width: auto !important; height:auto !important;">
          ...
          <a href="<?php echo get_name_page($idsite,$row_page_Inscription['id_page']); ?>" id="signupp_user" class="radio"><?php echo HAVE_NOT_COUNT; ?>?</a><br />
			  <br />
