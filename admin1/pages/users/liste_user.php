...
<div style="background-color:#ffffff;border-radius:0.5rem; padding-top:10px;margin-top:15px;">
  <table id="uutable" class="table row-border">
   <thead class="thead-light">
    ...
    <?php foreach ($client_lve->ListeClients() as $uuse): ?>
    <tr>
      ...
      <td>
        <div class="row" style="flex-wrap:inherit;">
          <button class="btn btn-outline-warning" style="width: 40px;height: 40px;border-radius:50%;" id="modifier"  data-toggle="modal" data-target="#mod-<?=$uuse['CLIENT_COD'];?>"><span><i class="fas fa-edit"></i></span></button>
          <button class="btn btn-outline-danger" style="width: 40px;height: 40px;border-radius:50%;" id="supprimer"  data-toggle="modal" data-target="#supmod-<?=$uuse['CLIENT_COD']; ?>"><span><i class="fas fa-trash"></i></span></button>
        </div>
         <!--#######################################################################################################-->
