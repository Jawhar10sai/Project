...
if (isset($_POST['performance_liv'])){
  ...
  $i = 1;
 $result = $connection->query("SELECT  *,(cas23/total) as global  from tdb_performance_liv where 1=1 AND agence =100 AND  dateedition ='$date' ORDER BY global DESC");
foreach ($result as $key) {
