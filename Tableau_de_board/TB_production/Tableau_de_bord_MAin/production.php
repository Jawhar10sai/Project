...
$data4 = '';
 ...
 <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="row">
          <img src="assets/images/voielvej.png" alt="" height="30">
        ...
        <table border="1" style="width:100%;" class="prod text-center">
          <tr>
            <td style="background-color:black;color:#fff;"><?=date('M'); ?></td>
          ...
          <tr>
            <td style="background-color:black;color:#fff;">Prod</td>
            <?php for ($i=1; $i <=date('t') ; $i++) {
          ...
          <tr>
            <td style="background-color:black;color:#fff;">Taux <br> Av 10</td>
            <?php for ($i=1; $i <=date('t') ; $i++) {
            				foreach ($result as $key) {
                				  if ($i==$key['j']) {
          ...
          <tr>
            <td style="background-color:black;color:#fff;">Taux <br>  Av 12</td>
            <?php for ($i=1; $i <=date('t') ; $i++) {
            				foreach ($result as $key) {
                				  if ($i==$key['j']) {
          ...
          <tr>
            <td style="background-color:black;color:#fff;">Taux <br>  Av 14</td>
            <?php for ($i=1; $i <=date('t') ; $i++) {
            				foreach ($result as $key) {
                				  if ($i==$key['j']) {
          ...
          <tr>
            <td style="background-color:black;color:#fff;">Taux <br>  Av 16</td>
            <?php for ($i=1; $i <=date('t') ; $i++) {
            				foreach ($result as $key) {
                				  if ($i==$key['j']) {
          ...
          <tr>
            <td style="background-color:black;color:#fff;">Taux <br>  Av 18</td>
            <?php for ($i=1; $i <=date('t') ; $i++) {
            				foreach ($result as $key) {
                				  if ($i==$key['j']) {
    ...
    <div class="row mt-5" style="max-height:40vh;">
      <div class="col-6">
